// ========== SUPABASE CLIENT ==========
const SUPABASE_URL = 'https://ouzofkfbkfldymszpgmd.supabase.co';
  
  
  
  const SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im91em9ma2Zia2ZsZHltc3pwZ21kIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODIzMjczMzQsImV4cCI6MjA5NzkwMzMzNH0.OSpSXU3LR1YxqaB2mmRAqmVXYupJQwhUupvgSEzKbGk';
...
async function generatePDF(id) {
  ...
  wrap.innerHTML = `<div style="text-align:center; margin-bottom:20px; border-bottom:2px solid #1F6E43; padding-bottom:16px;">
      <h1 style="color:#1F6E43;">A.B DAWANAU MEDICAL LABORATORY SERVICES</h1>
    ...
    ${rejectedNote}
    <div style="margin-top:20px; text-align:center; font-size:9px;">Electronically generated by A.B DAWANAU MEDICAL LABORATORY SERVICES LIS</div>`;
